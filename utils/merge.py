...
if __name__ == "__main__":
    ...
    input_path=r"E:\data\WHU-Railway3D-las\plateau_railway\npy\test"
    output_dir=r"E:\data\WHU-Railway3D-las\plateau_railway\npy\pred"
    input_format="npy"
    label_file="pred"
    label_remap_file=r"E:\data\WHU-Railway3D-las\plateau_railway\npy\train\label_mapping.json"
    template_las_file=None

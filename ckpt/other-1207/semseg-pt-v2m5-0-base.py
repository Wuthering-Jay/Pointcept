...
save_path = "exp/yn2city/semseg-pt-v2m5-0-base-20251206"
weight = "exp/yn2city/semseg-pt-v2m5-0-base-20251206/model/model_last.pth"
num_classes = 8
grid_size = 1.0

# dataset settings
dataset_type = "LasDataset"
data_root = r"D:\data\云南遥感中心数据第二批\new_disk03\tile200"
...
model = dict(
    ...
    criteria=[
        dict(type="CrossEntropyLoss",
             weight=[
# 0.0040913531238941404,
# 0.0049572927662330495,
# 0.004962125084648049,
# 0.07333378190360568,
# 0.03348381425712055,
# 0.8176406681473246,
# 0.02292345483407814,
# 0.013712007500224105,
# 0.02489550238287173

# 0.01648954218150524,
# 0.019531145061882024,
# 0.023619857209961032,
# 0.1560857077166589,
# 0.4907854710638583,
# 0.10976149961600269,
# 0.06516885315265701,
...
# 0.0076957091118362185,
# 0.005701996970914352,
# 0.026335640307692337,
# 0.3123823075545282,
# 0.3723610310246578,
# 0.1308470146197928,
# 0.07846983374632867,
...
0.026559842724173974, 
0.022157891847318718,
0.05129682240070982,
0.17879149291245722,
0.3640015077649569,
0.13850305650881253,

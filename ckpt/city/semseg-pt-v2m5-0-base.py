# 注意：_base_ 路径使用标准格式（相对于 configs/xxx/ 目录）
# predict.py 会自动处理路径问题，无需手动修改
...
save_path = "exp/yn2city/semseg-pt-v2m5-2-base"
weight = "exp/yn2city/semseg-pt-v2m5-2-base/model/model_last.pth"
num_classes = 8
grid_size = 1.0

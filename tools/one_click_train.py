...
weight_path = "exp/tj_f/semseg-pt-v2m2-0-base/model/model_last.pth"  # 预训练模型路径，None表示不加载预训练模型
...
ignore_labels = [1, 3, 4, 7, 9, 12, 13, 15, 20, 21, 22, 27, 28, 29]  # 忽略的类别标签
num_classes = 5  # 训练的类别数
point_distance = 0.2  # 点云采样间隔，单位米，略大于点云平均距离
########################################################
